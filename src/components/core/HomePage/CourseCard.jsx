    ...
    <div
      className={`w-full sm:w-[360px] lg:w-[30%] ${
        currentCard === cardData?.heading
          ...
          : "bg-richblack-800"
      }  text-richblack-25 h-auto sm:h-[300px] box-border cursor-pointer`}
      onClick={() => setCurrentCard(cardData?.heading)}
    >
      <div className="border-b-[2px] border-richblack-400 border-dashed h-auto sm:h-[80%] p-4 sm:p-6 flex flex-col gap-3">
        <div
          className={` ${
